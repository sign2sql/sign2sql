...
infiles_data_final = {'train_gloss': './all_data/example_split/train_gloss.txt',
                      'train_sql':'./all_data/example_split/train_sql.txt',
                      'train_db':'./all_data/example_split/train_db_id.txt',
                      'dev_gloss': './all_data/example_split/dev_gloss.txt',
                      'dev_sql':'./all_data/example_split/dev_sql.txt',
                      'dev_db':'./all_data/example_split/dev_db_id.txt',
                      'schema': './all_data/example_split/tables.json',
                      'test_gloss': './all_data/example_split/test_gloss.txt',
                      'test_sql':'./all_data/example_split/test_sql.txt',
                      'test_db':'./all_data/example_split/test_db_id.txt'
}



prefix_data_final = './all_data/example_split/data_final_processed_gloss'
infiles = {}
...
def count_databases(infile_group):
    ...
    with open(infile_group['test_db']) as f:
        for i,line in enumerate(f):
            if line.strip() not in content:
                content.add(line.strip())
