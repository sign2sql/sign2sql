...
class Seq2SQL_v1(nn.Module):
    ...
    def forward_no_where(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs,
...
def Loss_sw_se_no_where(s_sc, s_sa, s_wn, g_sc, g_sa, g_wn):
    loss = 0
