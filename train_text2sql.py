...
from sign2sql.utils.utils_sign2sql import load_sign2text, get_loader_sign2text
...
def train(train_loader, train_table, model, model_bert, opt, bert_config, tokenizer,
          ...
          st_pos=0, opt_bert=None, path_db=None, db_name='all'):
    model.train()
    model_bert.train()
...
if __name__ == '__main__':
    ...
    path_wikisql = '/home/huangwencan/data/sign2sql/dataset'

    path_save_for_evaluation = '../text2sql_save'
    ...
    if not args.trained:
        ...
        # no finetune bert
        # path_model_bert = '../pretrained_model_pts/model_bert_best.pt'
        # path_model = '../pretrained_model_pts/model_best.pt'
